...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            FeedItems transactionDetails;
            transactionDetails = client.getWeeklyTransactions(accountUid, categoryUid, startOfWeek, endOfWeek);
            ...
            // Ensure there is an amount to round up
            if (roundUpAmount <= 0) {
            ...
            SavingsGoalRequest goalRequest = new SavingsGoalRequest(savingsGoalName, "GBP", roundUpAmount);
            SavingsGoal savingsGoalResponse;
            savingsGoalResponse = client.createSavingsGoal(accountUid, goalRequest);
            ...
            SavingsGoalTransfer transferResponse;
            transferResponse = client.addMoneyToSavingsGoal(accountUid, savinggoalUId, roundUpAmount);
